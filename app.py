...
sep_len = st.number_input("sepal_length",min_value=0.0,step=0.1,value=5.1)
sep_width = st.number_input("sepal_width",min_value=0.0,step=0.1,value=3.5)
pet_len = st.number_input("petal_length",min_value=0.0,step=0.1,value=1.4)
pet_wid = st.number_input("petal_width",min_value=0.0,step=0.1,value=3.5)
